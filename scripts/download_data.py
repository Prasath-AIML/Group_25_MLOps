...
def main():
    ...
    print("\nInstructions:")
    print(
        "1. Download the dataset from: https://archive.ics.uci.edu/ml/datasets/heart+Disease"
    )
    ...
    if os.path.exists(ZIP_PATH):
        ...
        print(
            "Please download the dataset manually and place it in the data/ directory"
        )
