...
class TestModelTraining:
    ...
    def test_model_probability_prediction(self):
        ...
        assert probabilities.shape == (50, 2), "Probabilities should be (n_samples, n_classes)"
...
class TestModelPersistence:
    ...
    def test_model_loading(self, tmp_path):
        ...
        assert np.array_equal(predictions_original, predictions_loaded), "Loaded model should produce same predictions"
