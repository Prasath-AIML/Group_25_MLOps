...
class TestAPIEndpoints:
    ...
    def test_metrics_endpoint(self, client):
        ...
        assert (
            "api_requests_total" in content
        ), "Should contain api_requests_total metric"
        assert (
            "prediction_requests_total" in content
        ), "Should contain prediction_requests_total metric"
    ...
    def test_predict_endpoint_validation(self, client):
        ...
        ), "Should return validation error for wrong input"
    ...
    def test_predict_endpoint_empty_features(self, client):
        ...
        assert (
            response.status_code == 422
        ), "Should return validation error for empty features"
